...
class ScrolledWindow(gtk.ScrolledWindow):
    ...
    def __init__(self, hscrollbar_policy=gtk.POLICY_AUTOMATIC, vscrollbar_policy=gtk.POLICY_AUTOMATIC, 
        ...
        vscrollbar.set_size_request(
            theme.get_dynamic_pixbuf("scrollbar/vscrollbar_bg.png").get_pixbuf().get_width(), 
            -1)
        ...
        hscrollbar.set_size_request(
            -1,
            theme.get_dynamic_pixbuf("scrollbar/hscrollbar_bg.png").get_pixbuf().get_height(), 
            )
    ...
    def expose_hscrollbar(self, widget, event):
        ...
        if upper > lower:
            ...
            bg_pixbuf = theme.get_dynamic_pixbuf("scrollbar/hscrollbar_bg.png").get_pixbuf()
            fg_left_pixbuf = theme.get_dynamic_pixbuf("scrollbar/hscrollbar_fg_left.png").get_pixbuf()
            fg_middle_pixbuf = theme.get_dynamic_pixbuf("scrollbar/hscrollbar_fg_middle.png").get_pixbuf()
            fg_right_pixbuf = theme.get_dynamic_pixbuf("scrollbar/hscrollbar_fg_right.png").get_pixbuf()
    ...
    def expose_vscrollbar(self, widget, event):
        ...
        if upper > lower:
            ...
            cr = widget.window.cairo_create()
            rect = widget.allocation
            bg_pixbuf = theme.get_dynamic_pixbuf("scrollbar/vscrollbar_bg.png").get_pixbuf()
            fg_top_pixbuf = theme.get_dynamic_pixbuf("scrollbar/vscrollbar_fg_top.png").get_pixbuf()
            fg_middle_pixbuf = theme.get_dynamic_pixbuf("scrollbar/vscrollbar_fg_middle.png").get_pixbuf()
            fg_bottom_pixbuf = theme.get_dynamic_pixbuf("scrollbar/vscrollbar_fg_bottom.png").get_pixbuf()
            value = adjust.get_value()
            page_size = adjust.get_page_size()
            ...
            # Draw background.
            if self.draw_mask:
                vbg_pixbuf = theme.get_dynamic_pixbuf("scrollbar/vscrollbar_bg.png").get_pixbuf()
