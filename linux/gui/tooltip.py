...
class Tooltip(object):
    ...
    def __init__ (self, text, x, y, text_size=DEFAULT_FONT_SIZE, text_color="tooltipText",
        ...
        # Init Window.
        self.tooltip_window = gtk.Window(gtk.WINDOW_TOPLEVEL)
        ...
        # Init signal.
        self.tooltip_window.connect("size-allocate", draw_window_shape)
        self.tooltip_window.connect("focus-out-event", lambda w,e: self.exit())
        self.tooltip_window.connect("expose-event", self.expose_tooltip) 
    ...
    def expose_tooltip(self, widget, event):
        ...
        draw_vlinear(cr, rect.x, rect.y, rect.width, rect.height, 
                     theme.get_dynamic_shadow_color("tooltipBackground").get_color_info())
        
        # Draw frame.
        draw_window_frame(cr, rect, TOOLTIP_RADIUS, False)
        
        # Draw font.
        draw_font(cr, self.text, self.text_size, 
                  theme.get_dynamic_color(self.text_color).get_color(),
